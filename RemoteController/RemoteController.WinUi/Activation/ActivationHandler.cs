    ...
    where T : class
{
    ...
    public bool CanHandle(LaunchActivatedEventArgs? args) => args is T && CanHandleInternal((args as T)!);

    public async Task HandleAsync(LaunchActivatedEventArgs? args) => await HandleInternalAsync((args as T)!);
}
